...
* *Graded Comonad Framing:* RETRACTED (This is a thin-poset action, not
a comonad. See `+docs/retracted/retractions.adoc+`)
* *Universal Property / Terminal Cone:* RETRACTED (Requires funext, not
natively constructible. See `+docs/retracted/retractions.adoc+`)
...
* *Buchholz/Veblen Ordinal Representation:* BLOCKED (Well-foundedness of
shared-binder cases blocked on self-lift)
