...
[.lead]
Coherence pass requested by the legacy `roadmap.md` (now consolidated into `roadmap.adoc`) § "Theory work" item
...
* the legacy `roadmap.md` (now consolidated into `roadmap.adoc`) § "Theory work" entry updated from `[unblocked]`
