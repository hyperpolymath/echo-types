...
module Echo.Examples.EchoExamples where

open import Echo.Core
open import Echo.Characteristic using (collapse; echo-true; echo-false)
open import Echo.Residue using (collapse-to-residue; collapse-residue-same)
