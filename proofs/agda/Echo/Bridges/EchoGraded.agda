...
module Echo.Bridges.EchoGraded where

open import Echo.Core
open import Echo.Characteristic using (collapse)
open import Echo.Residue using (EchoR; TrivialCert; collapse-to-residue)
