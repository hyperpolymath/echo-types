...
module Echo.Bridges.EchoScope where

open import Echo.Core
open import Echo.Bridges.EchoIndexed using (Echoᵢ; forget-role; role-sound)
open import Echo.Residue using (EchoR)
open import Echo.Bridges.EchoRelational using (EchoStep; Graph; RelMap; map-rel; echo-to-graph; graph-to-echo)
open import Echo.Bridges.EchoCategorical using (SliceHom; arrow; commute; slice-act)
...
module _ {s o r} {S : Set s} {O : Set o} (Step : S → O → Set r) where
  module Fib = Echo.Bridges.EchoCategorical.Fibration Step
