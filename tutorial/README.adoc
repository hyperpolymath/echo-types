...
[IMPORTANT]
====
*Lane 5 unpark status (updated 2026-05-26).* Walkthrough 1
(certified region-exit audit) was accepted as the killer-app
candidate per `roadmap.adoc` §"Lane 5 [PARKED]" second unblocking
condition; Lane 5 is *active* on Walkthrough 1 only. Walkthroughs 2
and 3 remain at scaffold/design-doc level pending either Lane 1
close-out or independent unparking decisions.
